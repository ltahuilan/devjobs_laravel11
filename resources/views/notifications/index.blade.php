            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @forelse ($notifications as $notification )
                        <div class="md:flex md:justify-between md:items-center border-b-2 border-gray-700 p-2">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 py-2">{{ $notification->created_at->diffForHumans()}}</p>
                            </div>
